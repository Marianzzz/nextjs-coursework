...
import { NewsFormState, FormNews } from '@/lib/definitions';
import { toast } from 'react-toastify';

export default function NewsAddModal({ disciplines }: FormNews) {
    ...
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>Додати нову новину.</DialogDescription>
        </DialogHeader>
